...
const TemplatesSection = () => {
  ...
  // ─── Use Template → Navigate to CV Builder ───────────────
                ...
                <>
                  <ModalHeader>
                    ...
                    <Box display="flex" alignItems="center" gap={1}>
                      ...
                      <IconButton
                        ...
                        sx={{ color: '#64748b', '&:hover': { backgroundColor: '#e2e8f0', color: '#1e293b' } }}
                      >
                        <CloseIcon />
                      </IconButton>
                    </Box>
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          borderRadius: 1, overflow: 'hidden', backgroundColor: '#ffffff',
                        }}
                      >
                        <Box
                          component="img"
                  ...
                  <ZoomControls>
                    <IconButton onClick={handleZoomOut} disabled={zoomLevel <= 50} size="small"
                      sx={{ color: zoomLevel <= 50 ? '#cbd5e1' : '#64748b', '&:hover': { backgroundColor: '#e2e8f0' } }}>
                      <ZoomOutIcon />
                    </IconButton>
                    <Slider
                    ...
                    />
                    <IconButton onClick={handleZoomIn} disabled={zoomLevel >= 200} size="small"
                      sx={{ color: zoomLevel >= 200 ? '#cbd5e1' : '#64748b', '&:hover': { backgroundColor: '#e2e8f0' } }}>
                      <ZoomInIcon />
                    </IconButton>
                    <Typography variant="body2" color="text.secondary" sx={{ minWidth: 50, textAlign: 'center', fontWeight: 600 }}>
                      {zoomLevel}%
                    </Typography>
                    <IconButton onClick={handleZoomReset} size="small"
                      sx={{ color: '#64748b', '&:hover': { backgroundColor: '#e2e8f0' } }}>
                      <RestartAltIcon />
                    </IconButton>
                    <Button
